...
(set! geometry (append geometry 
                      (list   (make ellipsoid (center 0.25 (/ w 2) 0) (material air)
		      (size hx hy 30))
				(make ellipsoid (center -0.25 (/ (* -1 w) 2) 0) (material air)
		      (size hx hy 30))
)))
...
(define result (maximize-multiple lamtoneff 0.001 0.7 0.5 1.6 1.2))
